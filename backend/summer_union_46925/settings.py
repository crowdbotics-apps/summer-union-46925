"""
Django settings for summer_union_46925 project.
...
ROOT_URLCONF = 'summer_union_46925.urls'
...
WSGI_APPLICATION = 'summer_union_46925.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "summer_union_46925 API",
    "DESCRIPTION": "API documentation for summer_union_46925 App",
    "VERSION": "v1",
}
